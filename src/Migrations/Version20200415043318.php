 ...
 */
final class Version20200415043318 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE answer CHANGE from_doctor_id from_doctor_id INT DEFAULT NULL, CHANGE survey_id survey_id INT DEFAULT NULL, CHANGE content content VARCHAR(1000) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE answer CHANGE from_doctor_id from_doctor_id INT DEFAULT NULL, CHANGE survey_id survey_id INT DEFAULT NULL, CHANGE content content VARCHAR(1000) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
